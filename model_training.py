...
class ModelTraining:
    """
    Handles model training, evaluation, selection, and hyperparameter optimization.
    ...
    def __init__(self, enable_hyperparameter_optimization: bool = True):
        """
    ...
    def _select_best_model(self) -> None:
        ...
        logger.info(f"Best model selected: {best_model_name} (AUC: {best_auc:.4f})")
    ...
    def save_results(self, filename: Optional[str] = None) -> str:
        ...
        try:
            ...
            if self.optimized_models:
                results_serializable['hyperparameter_optimization'] = {
                    'enabled': True,
...
if __name__ == "__main__":
    ...
    mt = ModelTraining(enable_hyperparameter_optimization=True)
